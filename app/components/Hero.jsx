...
export default function Hero() {
  return (
    <div className="bg-[#d0d6ab] relative snap-section">
      <div className="bg-[url(/foto1.webp)] bg-no-repeat bg-cover bg-center relative  h-screen flex  justify-center mask_image"></div>
