          ...
          <div className="flex gap-3 mt-5">
            ...
            >
              <ul className="divide-y list-decimal px-2">
                <li className="p-1">Vestidos formales, elegantes, tacos.</li>
                <li className="p-1">No utilizar pantalones jeans.</li>
                <li className="p-1">
                  No utilizar colores blancos, beige, ni rojo.
                </li>
                <li className="p-1 font-bold text-primary">
                  El blanco está reservado única y exclusivamente para la novia.
                </li>
              </ul>
